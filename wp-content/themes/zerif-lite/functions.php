...
// 		$file['name'] = 'Raghav' . ' - ' . $post_name . '.' . $pathinfo['extension'];
// 		return $file;
// 	} // upload_prefilter
...
// 		"menu_name" => __( "Locations", "hello-elementor" ),
// 		"all_items" => __( "All Locations", "hello-elementor" ),
// 		"add_new" => __( "Add new location", "hello-elementor" ),
// 		"edit_item" => __( "Edit location", "hello-elementor" ),
// 		"new_item" => __( "New Location", "hello-elementor" ),
// 		"view_item" => __( "View Location", "hello-elementor" ),
// 		"search_items" => __( "Search Location", "hello-elementor" ),
// 		"not_found" => __( "No location found", "hello-elementor" ),
// 		"not_found_in_trash" => __( "No Location found in Trash", "hello-elementor" ),
// 	];

// 	$args = [
// 		"label" => __( "Locations", "hello-elementor" ),
// 		"labels" => $labels,
// 		"description" => "All location pages are under in this category",
// 		"public" => true,
...
function cptui_register_my_cpts_movies() {
	...
	$labels = [
		"name" => __( "Movies", "zerif-lite" ),
		"singular_name" => __( "Movie", "zerif-lite" ),
		"menu_name" => __( "My Movies", "zerif-lite" ),
		"all_items" => __( "All Movies", "zerif-lite" ),
		"add_new" => __( "Add New", "zerif-lite" ),
		"add_new_item" => __( "Add New Movie", "zerif-lite" ),
		"edit_item" => __( "Edit Movie", "zerif-lite" ),
	];

	$args = [
		"label" => __( "Movies", "zerif-lite" ),
		"labels" => $labels,
		"description" => "The movies list type.",
		"public" => true,
		"publicly_queryable" => true,
		"show_ui" => true,
		"show_in_rest" => true,
...
function cptui_register_my_taxes_actors() {
	...
	$labels = [
		"name" => __( "Actors", "zerif-lite" ),
		"singular_name" => __( "Actor", "zerif-lite" ),
	];

	$args = [
		"label" => __( "Actors", "zerif-lite" ),
		"labels" => $labels,
		"public" => true,
		"publicly_queryable" => true,
		"hierarchical" => false,
		...
		"show_in_nav_menus" => true,
		"query_var" => true,
		"rewrite" => [ 'slug' => 'actors', 'with_front' => true, ],
...
add_action( 'init', 'cptui_register_my_taxes_actors' );
